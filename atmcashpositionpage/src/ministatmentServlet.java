...
/**
 * Servlet implementation class ministatmentServlet
 */
@WebServlet("/ministatmentServlet")
public class ministatmentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ministatmentServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HttpSession session=request.getSession(false);  
		  ...
		  RequestDispatcher rd = request.getRequestDispatcher("/ministatment.jsp");
